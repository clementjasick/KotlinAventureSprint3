...
class GenerateurTypeArmes(val cheminFichier: String) {
    ...
    for (i in 1..listeObjCSV.lastIndex) {
        ...
        val objet = TypeArme(nom = ligneObjet[0], valeurDeMax = ligneObjet[1].toInt(), nombreDes = ligneObjet[2].toInt(), multiplicateurCritique = ligneObjet[2].toInt(), activationCritique = ligneObjet[3].toInt())
        mapObjets[cle] = objet
    }
    return mapObjets
}
